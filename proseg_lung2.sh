...
transcript_file=~/data/spatial_data/merfish_pancancer/HumanLungCancerPatient2/detected_transcripts.processed.csv
output_dir=~/data/spatial_data/merfish_pancancer/HumanLungCancerPatient2/proseg_results
