...
transcript_file=~/data/spatial_data/merfish_pancancer/HumanColonCancerPatient1/detected_transcripts.processed.csv
output_dir=~/data/spatial_data/merfish_pancancer/HumanColonCancerPatient1/proseg_results
