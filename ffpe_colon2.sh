...
transcript_file="$DATA_DIR/HumanColonCancerPatient2/detected_transcripts.csv"
processed_transcripts_file="$DATA_DIR/HumanColonCancerPatient2/detected_transcripts.processed.csv"
